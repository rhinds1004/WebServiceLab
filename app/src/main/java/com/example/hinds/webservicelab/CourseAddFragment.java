 ...
 * {@link CourseAddFragment.CourseAddListener} interface
...
public class CourseAddFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCourseIdEditText = (EditText) v.findViewById(R.id.editText_add_course_id);
        mCourseShortDescEditText = (EditText) v.findViewById(R.id.editText_add_course_short_desc);
        mCourseLongDescEditText = (EditText) v.findViewById(R.id.editText_add_course_long_desc);
        mCoursePrereqsEditText = (EditText) v.findViewById(R.id.editText_add_course_prereqs);

        Button addCourseButton = (Button) v.findViewById(R.id.button_add_course);
